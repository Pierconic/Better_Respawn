...
public class DuatAnchorChargeProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (((entity instanceof Player _plr ? _plr.experienceLevel : 0) >= 8 || (entity instanceof Player _plr ? _plr.getAbilities().instabuild : false))
				&& ((entity instanceof Player _plr ? _plr.getAbilities().instabuild : false) || found == false)) {
			if (entity instanceof Player _player)
				_player.giveExperiencePoints(-(80));
			world.setBlock(BlockPos.containing(x, y, z), BetterRespawnModBlocks.ACTIVATED_DUAT_ANCHOR.get().defaultBlockState(), 3);
